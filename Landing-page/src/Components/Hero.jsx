...
export default function(){
    ...
    return(
        ...
        <div className="Hero-center"><h1>Generate more leads with a professional landing page!</h1>
          <div className="Hero-div2">


          <input type="email" placeholder="Email Address"></input>
            <button type="button" className="btn btn-primary heroBtn">Submit</button>
          </div>
